...
Take two functions: $f_i$ defined over $u_i$, and $f_j$ defined over $u_j$. If the two sets overlap, each of the functions can be restricted to the overlap  ...

#figure(
  image("chap31.png", width: 50%),
  caption: [Skinless fruits, are open set]
)
